...
type GatewayApplicationRepository interface {
	...
	Create(ctx context.Context, cluster domain.KubeCluster, application *domain.GatewayApplication) (*domain.GatewayApplication, error)
...
type GatewayApplicationService struct {
	sparkAppRepo          GatewayApplicationRepository
...
func (s *GatewayApplicationService) GetClusterNamespaceFromGatewayId(gatewayId string) (*domain.KubeCluster, string, error) {
...
func (s *GatewayApplicationService) Get(ctx context.Context, gatewayId string) (*domain.GatewayApplication, error) {
...
func (s *GatewayApplicationService) List(ctx context.Context, cluster string, namespace string) ([]*metav1.ObjectMeta, error) {
...
func (s *GatewayApplicationService) Create(ctx context.Context, application *v1beta2.SparkApplication, user string) (*domain.GatewayApplication, error) {
...
func (s *GatewayApplicationService) Status(ctx context.Context, gatewayId string) (*v1beta2.SparkApplicationStatus, error) {
	cluster, namespace, err := s.GetClusterNamespaceFromGatewayId(gatewayId)
	if err != nil {
		return nil, err
	}
...
func (s *GatewayApplicationService) Logs(ctx context.Context, gatewayId string, tailLines int) (*string, error) {
	cluster, namespace, err := s.GetClusterNamespaceFromGatewayId(gatewayId)
	if err != nil {
		return nil, err
	}
...
func (s *GatewayApplicationService) Delete(ctx context.Context, gatewayId string) error {
	cluster, namespace, err := s.GetClusterNamespaceFromGatewayId(gatewayId)
	if err != nil {
		return err
	}
...
func (s *GatewayApplicationService) SparkApplicationValidator(application *v1beta2.SparkApplication) []string {
	var errors []string
	if application == nil {
...
func (s *GatewayApplicationService) SparkApplicationOverrides(application *v1beta2.SparkApplication, user string, appName string) *v1beta2.SparkApplication {
	if application.Name != "" {
